...
namespace TrasferSystemTests
{
    ...
    public class TestEmployeeRepository
    {
        ...
        public void TestAdd()
        {
            var Employee = new Employee(_employeeid: 2000, _user_: "Inlucker", _company: 1, _department: null, _permission_: 3);
            ...
            Assert.AreEqual("Inlucker", checkEmployee1.User_, "Not equal Added Employee");
        ...
        public void TestGetAll()
        {
            ...
            Assert.AreEqual("Inlucker", Employees.Last().User_, "Not equal Added Employee");
        ...
        public void TestUpdate()
        {
            ...
            Employee newEmployee = new Employee(_employeeid: addedEmployee.Employeeid, _user_: "Inlucker", _company: 1, _department: null, _permission_: 1);
            ...
            Assert.AreEqual("Inlucker", newEmployee.User_, "Not equal added Employee");
        ...
        public void TestGetEmployeeByID()
        {
            ...
            Assert.AreEqual("Inlucker", checkEmployee1.User_, "Not equal found Employee");
        ...
        {
            var Employee = new Employee(_employeeid: 2000, _user_: "Inlucker", _company: 1, _department: 1, _permission_: 3);
            var context = new transfersystemContext(Connection.GetConnection(Permissions.Founder.ToString()));
            ...
            Employee checkEmployee = rep.GetEmployeeByWorkplace("Inlucker", 1, 1);

            Assert.IsNotNull(checkEmployee, "Can't find Employees");
            Assert.AreEqual("Inlucker", checkEmployee.User_, "Not equal found Employee");
